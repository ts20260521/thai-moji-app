...
THAI_CONSONANTS = {
    ...
    "ข": ["kho khai (卵のkh)", "ko kai (鶏のk)", "so so (鎖のs)", "cho chan (皿のc)"],
    ...
    "บ": ["bo baimai (葉のb)", "po pla (魚のp)", "pho phan (トレーのph)", "fo fan (歯のf)"],
    "ป": ["po pla (魚のp)", "bo baimai (葉のb)", "pho phan (トレーのph)", "fo fa (蓋のf)"],
    "ผ": ["pho phung (蜂のph)", "fo fa (蓋のf)", "pho phan (トレーのph)", "pho samphao (ジャンク船のph)"],
    "ฝ": ["fo fa (蓋のf)", "pho phung (蜂のph)", "fo fan (歯のf)", "pho phan (トレーのph)"],
    "พ": ["pho phan (トレーのph)", "fo fan (歯のf)", "pho phung (蜂のph)", "pho samphao (ジャンク船のph)"],
    "ฟ": ["fo fan (歯のf)", "pho phan (トレイのph)", "fo fa (蓋のf)", "lo ling (猿のl)"],
    "ภ": ["pho samphao (ジャンク船のph)", "pho phan (トレーのph)", "mo ma (馬のm)", "ko kai (鶏のk)"],
    ...
    "ห": ["ho hip (箱のh)", "ɔ ang (洗面器のɔɔ)", "ho nokhuk (ミミズクのh)", "pho samphao (ジャンク船のph)"],
